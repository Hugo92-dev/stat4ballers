...
export default function EintrachtFrankfurtPage() {
  const joueurs = generatePlayers('Eintracht Frankfurt', 15);
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {joueurs.map(joueur => (
            <div key={joueur.id} className="bg-white p-6 rounded-lg shadow-md">
              ...
              <Link 
                href={`/bundesliga/eintracht-frankfurt/${joueur.id}`}
