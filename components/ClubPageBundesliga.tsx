...
export default function ClubPageBundesliga({ 
  clubId, 
  clubName, 
  leagueId, 
  leagueName,
  ...
  const team = bundesligaTeams.find(t => t.slug === clubId);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black p-8">
        <div className="max-w-7xl mx-auto text-center text-white">
          ...
          <Link href="/bundesliga" className="text-blue-400 hover:underline">
      ...
      <div className="max-w-7xl mx-auto px-8 py-6">
        <div className="relative max-w-md mx-auto">
          <input
            ...
            className="w-full px-6 py-3 bg-gray-800 text-white rounded-full border border-gray-700 focus:border-gray-500 focus:outline-none pl-12"
          />
