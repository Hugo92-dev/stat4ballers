...
LIGUE1_TEAMS = [
    ...
    {'id': 4508, 'name': 'Paris FC', 'slug': 'paris-fc'},  # Nouveau promu
    {'id': 3513, 'name': 'FC Metz', 'slug': 'metz'},  # Nouveau promu
    {'id': 9257, 'name': 'FC Lorient', 'slug': 'lorient'}  # Nouveau promu
]
...
def main():
    print("=" * 60)
    print("MISE À JOUR DES EFFECTIFS LIGUE 1 - SAISON 2025/2026")
    print("Avec les 18 clubs corrects (incluant Paris FC, Metz, Lorient)")
    print("=" * 60)
    ...
    if all_teams_data:
        ...
        # Afficher les nouveaux clubs
        print(f"\n🆕 Nouveaux clubs ajoutés:")
        for team, players in all_teams_data:
            if team['slug'] in ['paris-fc', 'metz', 'lorient']:
                print(f"  - {team['name']}: {len(players)} joueurs")
    else:
