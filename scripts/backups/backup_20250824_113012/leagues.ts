...
export const premierLeagueTeams: Team[] = [
  ...
  { id: 'burnley', name: 'Burnley', stadium: 'Turf Moor', founded: 1882, colors: ['#6C1D45', '#99D6EA'] },
  ...
  { id: 'sunderland', name: 'Sunderland', stadium: 'Stadium of Light', founded: 1879, colors: ['#EB172B', '#FFFFFF'] },
...
export const ligaTeams: Team[] = [
  ...
  { id: 'barcelona', name: 'FC Barcelona', stadium: 'Camp Nou', founded: 1899, colors: ['#A50044', '#004D98'] },
  { id: 'atletico-madrid', name: 'Atlético Madrid', stadium: 'Civitas Metropolitano', founded: 1903, colors: ['#CE3524', '#FFFFFF', '#272E61'] },
  { id: 'athletic-bilbao', name: 'Athletic Club', stadium: 'San Mamés', founded: 1898, colors: ['#EE2523', '#FFFFFF', '#000000'] },
  ...
  { id: 'sevilla', name: 'Sevilla', stadium: 'Ramón Sánchez Pizjuán', founded: 1890, colors: ['#F43333', '#FFFFFF'] },
  { id: 'villarreal', name: 'Villarreal', stadium: 'Estadio de la Cerámica', founded: 1923, colors: ['#FFE667', '#005187'] },
  { id: 'valencia', name: 'Valencia', stadium: 'Mestalla', founded: 1919, colors: ['#EE3524', '#FFDF1C'] },
  { id: 'girona', name: 'Girona', stadium: 'Estadi Montilivi', founded: 1930, colors: ['#CD2534', '#FFFFFF'] },
  { id: 'osasuna', name: 'Osasuna', stadium: 'El Sadar', founded: 1920, colors: ['#D91A21', '#0A346F'] },
  { id: 'getafe', name: 'Getafe', stadium: 'Coliseum Alfonso Pérez', founded: 1983, colors: ['#005999', '#FFFFFF'] },
  { id: 'celta-vigo', name: 'Celta de Vigo', stadium: 'Balaídos', founded: 1923, colors: ['#8AC3EE', '#FFFFFF'] },
  { id: 'mallorca', name: 'Mallorca', stadium: 'Visit Mallorca Estadi', founded: 1916, colors: ['#E20613', '#000000'] },
  { id: 'alaves', name: 'Deportivo Alavés', stadium: 'Mendizorroza', founded: 1921, colors: ['#0761AF', '#FFFFFF'] },
  { id: 'rayo-vallecano', name: 'Rayo Vallecano', stadium: 'Campo de Vallecas', founded: 1924, colors: ['#E53027', '#FFFFFF'] },
  { id: 'espanyol', name: 'Espanyol', stadium: 'RCDE Stadium', founded: 1900, colors: ['#007FC8', '#FFFFFF'] },
  { id: 'real-oviedo', name: 'Real Oviedo', stadium: 'Carlos Tartiere', founded: 1926, colors: ['#005EB8', '#FFFFFF'] },
  { id: 'levante', name: 'Levante', stadium: 'Ciutat de València', founded: 1909, colors: ['#004B87', '#B21E29'] },
  { id: 'elche', name: 'Elche', stadium: 'Manuel Martínez Valero', founded: 1923, colors: ['#4B7F3C', '#FFFFFF'] }
];
